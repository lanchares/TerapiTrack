...
def poblar_datos():
    ...
    usuarios_data = [
        ...
        # 5 Profesionales
        {'nombre': 'Dr. Juan', 'apellidos': 'Perez', 'email': 'juan.perez@terapitrack.com', 'rol': 2, 'password': 'medico123', 'especialidad': 'Rehabilitación Neurológica', 'tipo': 'MEDICO'},
        {'nombre': 'Terapeuta Ana', 'apellidos': 'Lopez', 'email': 'ana.lopez@terapitrack.com', 'rol': 2, 'password': 'terapeuta123', 'especialidad': 'Fisioterapia Neurológica', 'tipo': 'TERAPEUTA'},
        {'nombre': 'Psicólogo Carlos', 'apellidos': 'Gomez', 'email': 'carlos.gomez@terapitrack.com', 'rol': 2, 'password': 'psicologo123', 'especialidad': 'Neuropsicología', 'tipo': 'PSICOLOGO'},
        {'nombre': 'Enfermero Luis', 'apellidos': 'Martinez', 'email': 'luis.martinez@terapitrack.com', 'rol': 2, 'password': 'enfermero123', 'especialidad': 'Cuidados Neurológicos', 'tipo': 'ENFERMERO'},
        {'nombre': 'Dr. Maria', 'apellidos': 'Sanchez', 'email': 'maria.sanchez@terapitrack.com', 'rol': 2, 'password': 'medico123', 'especialidad': 'Neurología', 'tipo': 'MEDICO'},
        
        # 15 Pacientes con Parkinson
        {'nombre': 'Antonio', 'apellidos': 'García Martín', 'email': 'antonio.garcia@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1950,1,15), 'condicion': 'Parkinson - Estadio I', 'notas': 'Temblor leve en mano derecha'},
        {'nombre': 'María Carmen', 'apellidos': 'López Silva', 'email': 'mariacarmen.lopez@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1948,3,22), 'condicion': 'Parkinson - Estadio II', 'notas': 'Rigidez bilateral, bradicinesia'},
        {'nombre': 'José Manuel', 'apellidos': 'Rodríguez Vega', 'email': 'josemanuel.rodriguez@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1952,7,8), 'condicion': 'Parkinson - Estadio I', 'notas': 'Diagnóstico reciente'},
        {'nombre': 'Isabel', 'apellidos': 'Fernández Ruiz', 'email': 'isabel.fernandez@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1945,11,30), 'condicion': 'Parkinson - Estadio II', 'notas': 'Problemas de equilibrio'},
        {'nombre': 'Francisco', 'apellidos': 'Jiménez Torres', 'email': 'francisco.jimenez@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1949,5,12), 'condicion': 'Parkinson - Estadio II', 'notas': 'Temblor en reposo'},
        {'nombre': 'Carmen', 'apellidos': 'Moreno Castillo', 'email': 'carmen.moreno@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1951,9,18), 'condicion': 'Parkinson - Estadio I', 'notas': 'Lentitud de movimientos'},
        {'nombre': 'Miguel', 'apellidos': 'Sánchez Herrera', 'email': 'miguel.sanchez@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1946,2,14), 'condicion': 'Parkinson - Estadio III', 'notas': 'Inestabilidad postural'},
        {'nombre': 'Dolores', 'apellidos': 'Ortega Muñoz', 'email': 'dolores.ortega@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1953,8,25), 'condicion': 'Parkinson - Estadio I', 'notas': 'Temblor de acción'},
        {'nombre': 'Rafael', 'apellidos': 'Delgado Peña', 'email': 'rafael.delgado@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1947,12,3), 'condicion': 'Parkinson - Estadio II', 'notas': 'Rigidez en cuello'},
        {'nombre': 'Pilar', 'apellidos': 'Romero Aguilar', 'email': 'pilar.romero@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1950,6,19), 'condicion': 'Parkinson - Estadio I', 'notas': 'Micrografía'},
        {'nombre': 'Fernando', 'apellidos': 'Vargas Medina', 'email': 'fernando.vargas@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1954,4,7), 'condicion': 'Parkinson - Estadio II', 'notas': 'Marcha festinante'},
        {'nombre': 'Rosa', 'apellidos': 'Iglesias Cortés', 'email': 'rosa.iglesias@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1948,10,11), 'condicion': 'Parkinson - Estadio II', 'notas': 'Bradicinesia severa'},
        {'nombre': 'Eduardo', 'apellidos': 'Castro Blanco', 'email': 'eduardo.castro@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1951,1,28), 'condicion': 'Parkinson - Estadio I', 'notas': 'Pérdida de expresión facial'},
        {'nombre': 'Amparo', 'apellidos': 'Prieto Navarro', 'email': 'amparo.prieto@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1949,7,16), 'condicion': 'Parkinson - Estadio III', 'notas': 'Congelamiento de la marcha'},
        {'nombre': 'Joaquín', 'apellidos': 'Rubio Serrano', 'email': 'joaquin.rubio@email.com', 'rol': 1, 'password': 'paciente123', 'fecha_nac': date(1952,3,9), 'condicion': 'Parkinson - Estadio II', 'notas': 'Distonía focal'}
    ]
    ...
    ejercicios_data = [
        ...
        # Nuevos ejercicios específicos para Parkinson
    ...
    for i, (pid, prid) in enumerate(vinculaciones):
        # Crear entre 6 y 10 sesiones por paciente
        num_sesiones = random.randint(6, 10)

        for j in range(num_sesiones):
            # Aproximadamente mitad pasadas (COMPLETADAS) y mitad futuras (PENDIENTE)
            if j < num_sesiones * 0.5:
                estado = 'COMPLETADA'
                # Sesiones completadas en los últimos 90 días
                fecha_programada = date.today() - timedelta(days=random.randint(5, 90))
            else:
                estado = 'PENDIENTE'
                # Sesiones pendientes en los próximos 30 días
    ...
    for s in sesiones:
        ...
        for ej in selected_ej:
            ...
            # Si la sesión está completada, crear videos de respuesta y evaluaciones
            if s.Estado == 'COMPLETADA':
                ...
                # Crear evaluación (70% de las sesiones completadas tienen evaluación)
