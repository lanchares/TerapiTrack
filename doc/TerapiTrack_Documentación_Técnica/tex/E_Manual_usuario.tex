...
\begin{itemize}
  ...
  \item Al seleccionar una sesión pendiente, la aplicación muestra una pantalla dividida en dos partes: el vídeo demostrativo del ejercicio y la imagen de la cámara del paciente.
  Durante la sesión, el sistema graba automáticamente la ejecución de cada ejercicio.
