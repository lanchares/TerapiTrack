...
En primer lugar se representan la creación de usuarios por parte del administrador, la creación de ejercicios, la vinculación de pacientes y profesionales y la asignación de sesiones terapéuticas por parte de los profesionales (Figuras~\ref{fig:act-crea-usuario-ejercicio} y \ref{fig:act-vincular-sesion}).
A continuación se describen la realización en directo de una sesión por parte del paciente, guiado por el profesional, y la evaluación posterior de los vídeos grabados (Figuras~\ref{fig:act-realizar} y \ref{fig:act-evaluar}).

\begin{figure}[H]
  \centering
  \subfloat[\label{fig:actividad-crear-usuario}]{
    \includegraphics[width=0.42\textwidth]{img/actividad_crear_usuario.png}
  }\hfill
  \subfloat[\label{fig:actividad-crear-ejercicio}]{
    \includegraphics[width=0.42\textwidth]{img/actividad_crear_ejercicio.png}
  }
  \caption{Diagramas de actividad de creación de usuario y de ejercicio.}
  \label{fig:act-crea-usuario-ejercicio}
\end{figure}

\begin{figure}[H]
  \centering
  \subfloat[\label{fig:actividad-vincular}]{
    \includegraphics[width=0.42\textwidth]{img/actividad_vincular.png}
  }\hfill
  \subfloat[\label{fig:actividad-crear-sesion}]{
    \includegraphics[width=0.42\textwidth]{img/actividad_crear_asignar_sesion.png}
  }
  \caption{Diagramas de actividad de vinculación y creación de sesión.}
  \label{fig:act-vincular-sesion}
\end{figure}

\begin{figure}[H]
  \centering
  \subfloat[\label{fig:actividad-realizar-sesion}]{
    \includegraphics[width=\textwidth]{img/actividad_realizar_sesion.png}
  }
  \caption{Diagrama de actividad de realización de una sesión.}
  \label{fig:act-realizar}
\end{figure}

\begin{figure}[H]
  \centering
  \subfloat[\label{fig:actividad-evaluar-sesion}]{
    \includegraphics[width=0.6\textwidth]{img/actividad_evaluar_sesion.png}
  }
  \caption{Diagrama de actividad de evaluación de una sesión.}
  \label{fig:act-evaluar}
\end{figure}

\subsection{Diagrama de secuencia de una terapia guiada}

En la Figura~\ref{fig:seq-terapia-guiada} se representa, mediante un diagrama de secuencia UML, la interacción típica entre el profesional, el paciente y TerapiTrack durante una sesión de terapia guiada en directo. El diagrama recoge desde la programación y aceptación de la sesión hasta la ejecución de los ejercicios y el registro de los vídeos y resultados en el sistema, mostrando los mensajes clave intercambiados entre los actores y los componentes principales de la aplicación.
 
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{img/secuencia_sesion_guiada.png}
  \caption{Diagrama de secuencia de una sesión de terapia guiada entre profesional y paciente en TerapiTrack.}
  \label{fig:seq-terapia-guiada}
\end{figure}