...
El \textit{backend} está construido sobre Python y el \textit{microframework} Flask para la gestión de rutas y controladores, mientras que la persistencia de datos se resuelve con SQLAlchemy sobre SQLite~\cite{SQLAlchemyDocs,FlaskDocs}.
