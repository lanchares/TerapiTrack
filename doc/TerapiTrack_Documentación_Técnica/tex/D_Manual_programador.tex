...
Como complemento a las pruebas anteriores, se ejecutaron sentencias SQL directamente sobre la base de datos SQLite utilizando DB Browser for SQLite \cite{dbbrowser_sqlite}. El objetivo era validar operaciones típicas de mantenimiento (actualizaciones y consultas) y comprobar que las restricciones de clave primaria y foránea no impedían los cambios habituales.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{img/dbbrowser_borrados.png}
