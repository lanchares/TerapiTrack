...
Primero se abordan nociones relacionadas con la enfermedad de Parkinson y la rehabilitación y, a continuación, se describen los principios de accesibilidad, los patrones de diseño y los modelos de datos que se han tenido en cuenta durante el desarrollo.
...
En la parte de paciente de TerapiTrack estas ideas se han traducido en un menú sencillo, textos breves y claros, pocos elementos interactivos por pantalla y compatibilidad con dispositivos alternativos, como el mando SNES integrado únicamente en las vistas de paciente~\cite{GithubTerapitrack}.
...
y \textbf{muchos a muchos}, como ocurre al vincular pacientes con varios profesionales sanitarios o al asociar ejercicios concretos a distintas sesiones, que se representan mediante tablas intermedias específicas~\cite{date_db}.
