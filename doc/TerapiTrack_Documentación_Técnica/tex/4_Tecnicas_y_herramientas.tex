...
Sobre Python se ha utilizado el framework web \textbf{Flask}, que proporciona las piezas básicas para construir una aplicación web:
...
WSGI (Web Server Gateway Interface) es una especificación que define cómo se comunican las aplicaciones web en Python con los servidores que las ejecutan, de manera que distintos servidores y frameworks puedan interoperar entre sí~\cite{FlaskDocs}.
