...
\begin{itemize}
    ...
    \item \textbf{LaTeX Workshop y Overleaf}: Herramientas para la edición y compilación de la memoria y los anexos en \LaTeX{}, combinando el trabajo local en Visual Studio Code con la plataforma colaborativa Overleaf \cite{UbuPlantillaLatex,OverleafEditor}. 
