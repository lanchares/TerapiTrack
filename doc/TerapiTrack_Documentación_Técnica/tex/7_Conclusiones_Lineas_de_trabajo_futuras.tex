...
Otro aspecto destacable es la incorporación de pruebas automatizadas con \textit{pytest} sobre los módulos más críticos, alcanzando una cobertura elevada en modelos, decoradores y componentes de configuración~\cite{PytestDocs}.
