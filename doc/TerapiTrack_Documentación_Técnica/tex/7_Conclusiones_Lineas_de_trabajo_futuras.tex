...
Además, se ha incorporado una trazabilidad básica de la evolución terapéutica a través del historial de sesiones y evaluaciones asociadas a cada paciente~\cite{GithubTerapitrack,HerokuTerapitrackApp}.
...
Actualmente el sistema ofrece un historial estructurado de sesiones y evaluaciones, pero se podrían incorporar gráficos más completos, filtros por tipo de ejercicio o por profesional y resúmenes periódicos tanto para los clínicos como para los propios pacientes.
