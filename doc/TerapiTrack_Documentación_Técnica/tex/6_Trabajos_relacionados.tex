...
El Trabajo Fin de Máster de José Miguel Ramírez Sanz exploró el uso de Detectron2, un \emph{framework} de detección de objetos y poses, para extraer información sobre la posición de las articulaciones de un paciente a partir de vídeos de ejercicios.
