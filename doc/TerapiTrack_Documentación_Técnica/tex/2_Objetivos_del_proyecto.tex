...
\begin{itemize}
    \item Construir una aplicación web modular que facilite el mantenimiento y la incorporación de nuevas funcionalidades en el futuro.\cite{GithubTerapitrack, pressman_ingenieria_sw}
    ...
    \item Desarrollar una interfaz web accesible y clara, especialmente pensada para pacientes con posibles dificultades motoras o cognitivas.\cite{telehealth_accessibility,wcag22}
