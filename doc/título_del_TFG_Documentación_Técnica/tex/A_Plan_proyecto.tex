...
El desarrollo de \textit{TerapiTrack} se gestionó mediante una metodología ágil, basada principalmente en Scrum, empleando Jira para la organización y seguimiento de tareas. Aunque la planificación inicial se estructuró en sprints, el avance práctico fue flexible y se adaptó constantemente al progreso real y a los retos técnicos del desarrollo individual. Por ello, la documentación en Jira refleja tanto la hoja de ruta como los reajustes efectuados en el proyecto.
